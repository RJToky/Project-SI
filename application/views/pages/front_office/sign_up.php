...
<body class="h-full flex bg-gray-100">
	<div class="container flex items-center justify-center mx-auto flex-col">
      ...
      <div class="rounded-lg p-5 bg-white grid grid-cols-1 gap-x-1 gap-y-6 sm:grid-cols-2">

        <div class="px-4 flex flex-col gap-2">
          <label class="text-gray-500 text-lg font-semibold">Entrer votre nom:</label>
          <input required name="nom" class="w-full text-lg h-14 px-6 py-2 rounded-full bg-[#F6F6F6] focus:outline-none text-gray-500" type="nom" placeholder="RAKOTOARIVONY">
        </div>

        <div class="px-4 flex flex-col gap-2">
          <label class="text-gray-500 text-lg font-semibold">Entrer prenom:</label>
          <input required name="prenom" class="w-full text-lg h-14 px-6 py-2 rounded-full bg-[#F6F6F6] focus:outline-none text-gray-500" type="text" placeholder="Judichaël">
        </div>

        <div class="px-4 flex flex-col gap-2 sm:col-span-2">
          <label class="text-gray-500 text-lg font-semibold">Entrer votre email:</label>
          <input required name="email" class="w-full text-lg h-14 px-6 py-2 rounded-full bg-[#F6F6F6] focus:outline-none text-gray-500" type="email" placeholder="example@example.com">
        </div>

        <div class="px-4 flex flex-col gap-2">
          <label class="text-gray-500 text-lg font-semibold">Entrer votre genre:</label>
          <select required class="w-full text-lg h-14 px-6 py-2 rounded-full bg-[#F6F6F6] focus:outline-none text-gray-500" name="genre" id="">
        ...
        <div class="px-4 flex flex-col gap-2">
          ...
          <input required name="dtn" class="w-full text-lg h-14 px-6 py-2 rounded-full bg-[#F6F6F6] focus:outline-none text-gray-500" type="date" placeholder="Mot de passe">
        </div>
